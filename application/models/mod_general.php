    ...
    */
    class mod_general extends CI_Model {
        ...
        /**
            ...
            * Esta funci�n obtiene las jornadas que han sido registradas
            * @access public
            * @return array
        */
        ...
        /**
            ...
            * Esta funci�n carga los a�os lectivos actual y un periodo despues
            * @access public
            * @return array
        */
        ...
        /**
            ...
            * Esta funci�n carga todos los a�os lectivos
            * @access public
            * @return array
        */
        ...
        /**
            ...
            * Esta funci�n obtiene un array con cada uno de los campos de la tabla anio_lectivo de acuerdo al a�o recibido
            * como par�metro
            * @access public
            * @param integer $Anio: a�o lectivo
            * @return array
        */
        ...
        /**
            ...
            * Esta funci�n obtiene los cursos que coincidan con los par�metros de jornada y nivel
            * @access public
        ...
        */
        function cargar_cursos($jornada,$nivel){
         ...
         /**
            ...
            * Esta funci�n ontiene los cursos que coincida con el par�metro jornada para ser mostrada en la vista de edici�n
            * de alumno
            * @access public
            * @param integer $jornada: id de la jornada
            * @return array
        */
        ...
        /**
            ...
            * Esta funci�n obtiene las especializaciones de los cursos de bachillerato 
            * @access public
            * @param integer $jornada: id de la jornada
        ...
        */
        ...
        /**
            ...
            * Esta funci�n obtiene los paralelos de los cursos a excepci�n de 2do. y 3ero. de Bachillerato
            * @access public
            * @param integer $jornada: id de la jornada
            * @param integer $curso: id del curso
            * @return array
        */
        ...
        /**
            ...
            * Esta funci�n obtiene los paralelos de 2do. y 3ero. de Bachillerato
            * @access public
            * @param integer $jornada: id de la jornada
            * @param integer $curso: id del curso
        ...
        */
        ...
        /**
            ...
            * Esta funci�n obtiene la data del curso_paralelo que coincida con el id pasado como par�metro
            * @access public
        ...
        */
        ...
        /**
            ...
            * Esta funci�n obtiene la data del curso_paralelo que coincida con la jornada, curso, especializaci�n 
            * y paralelo que han sido enviadas como par�metro
            * @access public
            * @param integer $jornada: id de la jornada
            * @param integer $curso: id del curso
            * @param integer $espec: id de la especializaci�n
        ...
        */
        ...
        /**
            ...
            * Esta funci�n carga los niveles de acuerdo a la jornada
            * @access public
            * @param integer $jornada: id de la jornada
            * @return string
        */
        ...
        /**
            ...
            * Esta funci�n realiza el join entre las tablas curso_paralelo y curso donde
            * el  cp_jornada_id sea igual a la jornada pasada por par�metro
            * @access public
            * @param integer $jornada: id de la jornada
            * @return array
        */
