        ...
        */ 
        function guardar_Alumno($parametros,$cpId,$repId)
        {
            ...
            $data = array(
                            ...
                            "alu_nombres"=>trim(strtoupper($txtNombres)),
                            "alu_apellidos"=>trim(strtoupper($txtApellidos)),
                            "alu_domicilio"=>trim(strtoupper($txtDomicilio)),
                            "alu_telefono"=>trim($txtTelef),
                            "alu_pais"=>$cmbPais,
                            "alu_lugar_nacimiento"=>trim(strtoupper($txtLugarNac)),
                            "alu_fecha_nacimiento"=> $fecha,
                            "alu_sexo"=>$rbSexo,
                            "alu_edad"=>$txtEdad,
                            "alu_madre_nombres"=>trim(strtoupper($txtNombMadre)),
                            "alu_madre_cedula"=>$txtCedMadre,
                            "alu_madre_ocupacion"=>trim(strtoupper($txtOcupMadre)),
                            "alu_madre_pais"=>$cmbPaisMadre,
                            "alu_padre_nombres"=>trim(strtoupper($txtNombPadre)),
                            "alu_padre_cedula"=>$txtCedPadre,
                            "alu_padre_ocupacion"=>trim(strtoupper($txtOcupPadre)),
                            "alu_padre_pais"=>$cmbPaisPadre,
                            "alu_principal_representante"=>$rbRepresent,
                            "alu_documentacion"=>$check,
                            "alu_comentarios"=>trim(strtoupper($txtComentarios)),
