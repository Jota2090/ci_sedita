        ...
        <div class="span3">
            <div class="well sidebar-nav" style="width:300px;">
                <ul class="nav nav-list">
                  ...
                  <li class="active"><a href="<?=site_url("listados/cuadro_honor")?>">Cuadro de Honor</a></li>
            ...
            <div class="well sidebar-nav" style="float:left;width:200px;margin:30px 0 0 50px">
                <ul class="nav nav-list">
                  ...
                  <li><a>En esta secci&oacute;n podr&aacute; <b>generar reportes</b> de los mejores promedios por curso.</a></li>
                </ul>
            </div><!--/.well -->
        </div>
        <div class="span9">
            <div class="panel">
                <form target="_blank" style="padding-right: 100px;" id="forma" name="forma" class="form-horizontal" action="<?=site_url("listados/generar_cuadro")?>" method="post" >
                   <input type="hidden" id="indicador" name="indicador" />
                   <fieldset>
                        <legend>Cuadro de Honor</legend>
                        ...
                        <div class="control-group" style="width:300px;float:left; margin: 25px 0 0 0;" >
                            <label class="control-label" style="margin-top: 25px;"><b>Trimestre</b></label>
                   ...
                   <div class="control-group" style="float:left;width:800px; margin: 0 auto;" >
                        ...
                        <a href="javascript:generar()" id="btnGenerar" class="btn btn-primary" style="width: 125px; float:left;margin-top:20px" ><i class="icon-print"></i>Generar</a>
                    </div> 
                </form>
            </div>
        </div><!--/span-->
