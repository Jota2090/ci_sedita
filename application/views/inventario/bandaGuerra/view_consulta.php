    ...
    <script>
            function funcCmbBusquedaCateg(){
                   ...
                   else if ((valueCategoria=="Tipo")||(valueCategoria=="Estado"))
                   {
                        ...
                        data:"valueCategoria="+valueCategoria+"&tipo_id_objeto=2",
               ...
               function funcCmbOpciones(){
                ...
                var strCod=$("#txtCodInv").val()
                        ...
                        else
                        {
                            ...
                            $.ajax({
                                            type:'post',
                                            url: '<?=site_url("banda_guerra/consultar_instrumentos")?>',
        ...
        <div class="span3">
            <div class="well sidebar-nav" style="width:300px;">
                <ul class="nav nav-list">
                  ...
                  <li class="active"><a href="<?=site_url("banda_guerra/consultar_instrumentos")?>">Banda de Guerra</a></li>
            ...
            <div class="well sidebar-nav" style="width: 240px;">
                <ul class="nav nav-list">
                  ...
                  <li><a>En esta secci&oacute;n podr&aacute; <b>consultar y editar los instrumentos de la Banda  de Guerra</b> que pertenecen a la instituci&oacute;n.</a></li>
                </ul>
            </div><!--/.well -->
        </div>
        <div class="span9">
            <div class="panel" style="padding-bottom: 0px;">
                <form target="_blank" style="padding-right: 100px;" id="forma" name="forma" class="form-horizontal" action="<?=site_url("listados/exportar")?>" method="post" >
                   ...
                   <fieldset>
                       <legend>Instrumentos de la banda de guerra</legend>
