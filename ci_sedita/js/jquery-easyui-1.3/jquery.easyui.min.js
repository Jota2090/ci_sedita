...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"Este campo es obligatorio.",invalidMessage:null,rules:{email:{validator:function(_38b){
...
},message:"Entre {0} y {1} caracteres permitidos."},remote:{validator:function(_38f,_390){
var data={};
data[_390[1]]=_38f;
