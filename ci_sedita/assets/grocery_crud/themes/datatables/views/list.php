	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				?>			
				<?php if(!$unset_edit){?>
					<a onclick = "javascript: return edit_row('<?php echo $row->edit_url?>', '<?php echo $num_row?>')" 
                        href="javascript:void(0)" class="edit_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button">
