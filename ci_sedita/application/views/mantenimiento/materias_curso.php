    ...
    <head>
        ...
        <script>
            ...
            function fmcCmbCurso(){
                var curso = $("#cmbCur").find(":selected").val();
                
                if(curso > 11 && curso < 14){
                    $.ajax({
                        type:"post",
                        url: "<?=site_url("alumno/cargar_especializaciones")?>",
                        data:"curso="+curso+"&jornada=1",
                        success:function(info){
                            $("#cmbEsp").removeAttr('disabled');
                            $("#cmbEsp").html(info);
                        }
                   });   
                }
                ...
                <div class="panel span8" style="width:750px; margin-left:130px; padding:20px 0 20px 0;">
                    <div class="control-group span5">
                        ...
                        <div class="controls" style="margin-top: 10px;">
                            <select id="cmbCur" name="cmbCur" onChange="fmcCmbCurso()">
                                <?php echo $curso ?>
                            </select>
                        </div>
                        ...
                        <div class="controls" style="margin-top: 10px;">
                            <select disabled="disabled" id="cmbEsp" name="cmbEsp"></select>
                        </div>
                    </div>
                    <div class="control-group span4">
                        <a href="javascript:fncCmbMateria()" id="btnConsultar" class="btn btn-primary" style="width:120px;margin:40px 0 0 100px;" ><i class="icon-search"></i>Buscar</a>
                   </div>
                </div>
