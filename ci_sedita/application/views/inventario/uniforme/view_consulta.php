    ...
    <script>
            function funcCmbBusquedaCateg(){
                   ...
                   else if ((valueCategoria=="Tipo")||(valueCategoria=="Estado"))
                   {
                        ...
                        data:"valueCategoria="+valueCategoria+"&tipo_id_objeto=3",
               ...
               function funcCmbOpciones(){
                ...
                //alert(idOpcion);     
                        ...
                        $.ajax({
                                        type:'post',
                                        url: '<?=site_url("uniforme/consultar_uniformes")?>',
        ...
        <div class="span3">
            <div class="well sidebar-nav" style="width:300px;">
                <ul class="nav nav-list">
                  ...
                  <li class="active"><a href="<?=site_url("uniforme/consultar_uniformes")?>">Uniformes</a></li>
                </ul>
            </div><!--/.well -->
            <div class="well sidebar-nav" style="width: 240px;">
                <ul class="nav nav-list">
                  <li class="nav-header">Ayuda<i class="icon-question-sign" style="float: right;"></i></li>
                  <li><a>En esta secci&oacute;n podr&aacute; <b>consultar y editar los uniformes</b></a></li>
                </ul>
            </div><!--/.well -->
        </div>
        <div class="span9">
