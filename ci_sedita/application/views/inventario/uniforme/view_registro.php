  ...
  <body data-spy="scroll" data-target=".bs-docs-sidebar">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span3">
            <div class="well sidebar-nav" style="width:300px;">
                <ul class="nav nav-list">
                  ...
                  <li class="active"><a href="<?=site_url("uniforme")?>">Uniformes</a></li>
                </ul>
            </div><!--/.well -->
        ...
        <div class="span9">
            <div class="panel">
                <form class="form-horizontal" style="padding-right: 100px;" action="<?=site_url("uniforme/guardar") ?>" method="post" id="formUniforme" name="formUniforme">
                    <fieldset>
